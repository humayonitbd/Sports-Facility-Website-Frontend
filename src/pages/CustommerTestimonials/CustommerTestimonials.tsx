...
// import { Card, Typography, Button, Image, Row, Col, Grid } from "antd";
...
//   const contentPadding = screens.md ? "60px 100px" : "0 0";
...
//           width: `calc(100% - ${screens.md ? "0px" : "0px"})`, 
//           padding: `0 ${screens.md ? "100px" : "0px"}`, 
//           left: "0", 
//           right: "0",
//         }}
//       >
...
const CustomerTestimonials = () => {
  ...
  const renderStars = (rating: number) => {
    return Array(rating)
      .fill(0)
      .map((_, index) => <FaStar key={index} style={{ color: "#012363" }} />);
  };
    ...
    >
      ...
      <div
        ...
        style={{
          position: "absolute",
          top: "65%",
          width: screens.md ? "calc(100% - 0px)" : "100%",
          display: "flex",
          justifyContent: "space-between",
          transform: "translateY(-50%)",
          padding: `0 ${screens.md ? "100px" : "0"}`,
          left: 0,
          right: 0,
        }}
      >
